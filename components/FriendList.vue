<template>
  <div class="mb-4">
    ...
    <div v-for="friend in friends" :key="friend.id" class="px-4 relative inline-flex space-x-4 items-center w-full hover:bg-dark-800 cursor-pointer">
      ...
      <div v-if="friend.game" class="rounded-full overflow-hidden flex-initial" style="width:40px; height:40px;"><img :src="friend.game.logo" alt="" class="object-cover h-full w-full"></div>
      <!-- Friend Menu -->
